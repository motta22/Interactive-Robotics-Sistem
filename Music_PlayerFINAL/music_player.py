...
class Player(tk.Frame):
	...
	def control_widgets(self):
		...
		self.prev = tk.Button(self.controls, image=prev, bg='SlateGray4',width='100', height='100')
		self.prev['command'] = self.prev_song
		self.prev.grid(row=0, column=1)

		self.pause = tk.Button(self.controls, image=pause, bg='SlateGray4',width='100', height='100')
		self.pause['command'] = self.pause_song
		self.pause.grid(row=0, column=2)

		self.next = tk.Button(self.controls, image=next_, bg='SlateGray4',width='100', height='100')
		...
		# self.loadSongs['text'] = 'Load Songs'
		# self.loadSongs['command'] = self.retrieve_songs
		# self.loadSongs.grid(row=1, column=0, padx=10)

		self.mute = tk.Button(self.controls, image=mute, bg='SlateGray4',width='100', height='100')
		self.mute['command'] = self.mute_song
		self.mute.grid(row=1, column=1)

		self.volumeDown = tk.Button(self.controls, image=volumeDown, bg='SlateGray4',width='100', height='100')
		self.volumeDown['command'] = self.volume_down
		self.volumeDown.grid(row=1, column=2)

		self.volumeUp = tk.Button(self.controls, image=volumeUp, bg='SlateGray4',width='100', height='100')
